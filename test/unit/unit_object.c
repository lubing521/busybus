...
BBUSUNIT_DEFINETEST(basic_object)
{
	BBUSUNIT_BEGINTEST;
...
BBUSUNIT_REGISTER_TEST(basic_object);

BBUSUNIT_DEFINETEST(build_object)
{
	BBUSUNIT_BEGINTEST;
...
BBUSUNIT_REGISTER_TEST(build_object);

BBUSUNIT_DEFINETEST(parse_object)
{
	BBUSUNIT_BEGINTEST;
...
BBUSUNIT_REGISTER_TEST(parse_object);

BBUSUNIT_DEFINETEST(repr_object)
{
	BBUSUNIT_BEGINTEST;
...
BBUSUNIT_REGISTER_TEST(repr_object);

BBUSUNIT_DEFINETEST(repr_string)
{
	BBUSUNIT_BEGINTEST;
...
BBUSUNIT_REGISTER_TEST(repr_string);
